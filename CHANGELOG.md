...
Now Aged Lite is compatible with Aged.
You can now play together even with lower end pc's.
Also the update process is way easier on my end now.

This version is compatible with `Aged 3.1.0`
...
- LevelZ max level is now `30`
- Reworked a lot of levelz restrictions
...
- Chipped `3.0.6`
- Connectible Chains [Fabric] `2.2.1`
- Couplings `1.9.4`
- Crawl `0.12.0`
...
- Exposure `1.7.7`
- Fabric Language Kotlin `1.12.3 + k 2.0.21`
- Fzzy Config `0.5.3`
- GeckoLib `4.4.9`
...
- Surveyor Map Framework `0.6.24`
- TerraBlender `3.0.1.7`
- The Lost Castle `1.0.1`
